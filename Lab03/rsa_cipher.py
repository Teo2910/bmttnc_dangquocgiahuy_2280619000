...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        self.ui.btn_gen_keys.clicked.connect(self.call_api_gen_keys) # Giả định tên hàm này
        self.ui.btn_encrypt.clicked.connect(self.call_api_encrypt) # Giả định tên hàm này
